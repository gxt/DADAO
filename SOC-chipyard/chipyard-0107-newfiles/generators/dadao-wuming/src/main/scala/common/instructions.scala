...
object Instructions {
   ...
   def FT2RD		= BitPat("b01010000000010??????????????????")
   def FO2RD		= BitPat("b01010000001010??????????????????")
   def RD2FT		= BitPat("b01010000000011??????????????????")
   def RD2FO		= BitPat("b01010000001011??????????????????")
   def FTABS		= BitPat("b01010000000100??????????????????")
   def FTNEG		= BitPat("b01010000000101??????????????????")
   def FTSQRT		= BitPat("b01010000000110??????????????????")
   def FOABS		= BitPat("b01010000001100??????????????????")
   def FONEG		= BitPat("b01010000001101??????????????????")
   ...
   def FTCUN		= BitPat("b01010000100000??????????????????")
   def FTCOR		= BitPat("b01010000100001??????????????????")
   def FTCNE		= BitPat("b01010000100010??????????????????")
   def FTCEQ		= BitPat("b01010000100011??????????????????")
   def FTCLT		= BitPat("b01010000100100??????????????????")
   def FTCGE		= BitPat("b01010000100101??????????????????")
   def FTCGT		= BitPat("b01010000100110??????????????????")
   def FTCLE		= BitPat("b01010000100111??????????????????")
