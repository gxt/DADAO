   ...
   val csignals =
      ListLookup(io.dat.inst,
               ...
               Array(       /* val  |  BR  |  op1   |   op2     |  ALU    |  wb  | rf   | mem  | mem  | mask |  csr  */
                  ...
                  SWYM    -> List(Y, BR_N  , OP1_X  , OP2_X  ,  ALU_X    , WB_X  , REN_0, MEN_0, M_X  , MT_X,  CSR.N),
                  ...
                  ADDIrd  -> List(Y, BR_N  , OP1_RDHA, OP2_IMMS18, ALU_ADD ,  WB_RDHA, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  ADDIrb  -> List(Y, BR_N  , OP1_RBHA, OP2_IMMS18, ALU_ADD ,  WB_RBHA, REN_1, MEN_0, M_X  , MT_X,  CSR.N),

                  ADDrd   -> List(Y, BR_N  , OP1_RDHC, OP2_RDHD , ALU_ADD ,  WB_HAHB, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  SUBrd   -> List(Y, BR_N  , OP1_RDHC, OP2_RDHD , ALU_SUB ,  WB_HAHB, REN_1, MEN_0, M_X  , MT_X,  CSR.N),

                  LDBS    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_B,  CSR.N),
                  LDWS    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_W,  CSR.N),
                  LDTS    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_T,  CSR.N),
                  LDO     -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_O,  CSR.N),
                  LDBU    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_BU, CSR.N),
                  LDWU    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_WU, CSR.N),
                  LDTU    -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_TU, CSR.N),

                  STB     -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_B,  CSR.N),
                  STW     -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_W,  CSR.N),
                  STT     -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_T,  CSR.N),
                  STO     -> List(Y, BR_N  , OP1_RBHB, OP2_IMMS12, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_O,  CSR.N),
