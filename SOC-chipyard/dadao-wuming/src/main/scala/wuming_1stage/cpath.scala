   ...
   val csignals =
      ListLookup(io.dat.inst,
               ...
               Array(       /* val  |  BR  |  reg   |  op1   |   op2     |  ALU    |  wb  | rf   | mem  | mem  | mask |  csr  */
                  ...
                  CPCO    -> List(Y, BR_X  , REG_X  , OP1_X  , OP2_X  ,  ALU_X    , WB_X  , REN_0, MEN_0, M_X  , MT_X,  CSR.N),
                  ...
                  ANDI    -> List(Y, BR_X  , REG_RD ,  OP1_RDHB, OP2_IMMU12, ALU_AND ,  WB_RDHA, REN_1, MEN_0, M_X  , MT_X,  CSR.N),
                  ...
                  LDMBS   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_B,  CSR.N),
                  LDMWS   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_W,  CSR.N),
                  LDMTS   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_T,  CSR.N),
                  LDMO    -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_O,  CSR.N),
                  LDMBU   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_BU, CSR.N),
                  LDMWU   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_WU, CSR.N),
                  LDMTU   -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RDMM, REN_1, MEN_1, M_XRD, MT_TU, CSR.N),
                  ...
                  STMB    -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_B,  CSR.N),
                  STMW    -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_W,  CSR.N),
                  STMT    -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_T,  CSR.N),
                  STMO    -> List(Y, BR_X  , REG_MRD ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_O,  CSR.N),
                  ...
                  LDMRB   -> List(Y, BR_X  , REG_MRB ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_RBMM, REN_1, MEN_1, M_XRD, MT_O,  CSR.N),
                  STMRB   -> List(Y, BR_X  , REG_MRB ,  OP1_RBHB, OP2_RDHC, ALU_ADD ,  WB_X  , REN_0, MEN_1, M_XWR, MT_O,  CSR.N),
