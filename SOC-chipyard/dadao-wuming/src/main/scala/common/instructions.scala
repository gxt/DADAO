...
object Instructions {
   ...
   def CSNN		= BitPat("b00100001????????????????????????")
   def CSZ		= BitPat("b00100010????????????????????????")
   def CSNZ		= BitPat("b00100011????????????????????????")
   def CSP		= BitPat("b00100100????????????????????????")
   def CSNP		= BitPat("b00100101????????????????????????")
   def CSOD		= BitPat("b00100110????????????????????????")
   def CSEV		= BitPat("b00100111????????????????????????")
   ...
   def NOTr		= BitPat("b00010000010110??????????????????")
   ...
   def NOTi		= BitPat("b00010000011110??????????????????")
