...
LD_OPCODES = {LDBS, LDBU, LDWS, LDWU, LDTS, LDTU, LDT, LDOrd, LDOrb, LDOrf, LDMBS, LDMBU, LDMWS, LDMWU, LDMTS, LDMTU, LDMT, LDMOrd, LDMOrb, LDMOrf, LDMRA}
ST_OPCODES = {STB, STW, STTrd, STTrf, STOrd, STOrb, STOrf, STMB, STMW, STMTrd, STMTrf, STMOrd, STMOrb, STMOrf, STMRA}
