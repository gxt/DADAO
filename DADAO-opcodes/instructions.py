...
LD_OPCODES = {LDBS, LDBU, LDWS, LDWU, LDTS, LDTU, LDT, LDOrd, LDOrb, LDOrf, LDMBS, LDMBU, LDMWS, LDMWU, LDMTS, LDMTU, LDMO, LDMRB, LDMFT, LDMFO, LDMRA}
ST_OPCODES = {STB, STW, STTrd, STTrf, STOrd, STOrb, STOrf, STMB, STMW, STMT, STMO, STMRB, STMFT, STMFO, STMRA}
