...
LD_OPCODES = {LDBS, LDBU, LDWS, LDWU, LDTS, LDTU, LDMBS, LDMBU, LDMWS, LDMWU, LDMTS, LDMTU, LDMO, LDOrd, LDOrb, LDMRB, LDFT, LDFO, LDMFT, LDMFO, LDMRA}
ST_OPCODES = {STB, STW, STT, STOrd, STMB, STMW, STMT, STMO, STOrb, STMRB, STFT, STFO, STMFT, STMFO, STMRA}
