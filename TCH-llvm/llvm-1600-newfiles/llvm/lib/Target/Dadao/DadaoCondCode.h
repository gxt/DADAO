...
#ifndef LLVM_LIB_TARGET_DADAO_DADAOCONDCODE_H
...
inline static StringRef dadaoCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToDadaoCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_DADAO_DADAOCONDCODE_H
