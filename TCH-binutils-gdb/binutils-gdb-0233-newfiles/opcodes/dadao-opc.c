...
const struct dadao_opcode dadao_opcodes[] =
 {
	...
	{"ldb",		0x80,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldw",		0x82,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldt",		0x84,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldo",		0x86,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldbu",	0x88,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldwu",	0x8A,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldtu",	0x8C,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"ldsf",	0x8E,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},

	{"stb",		0x90,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"stw",		0x92,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"stt",		0x94,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"sto",		0x96,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
	{"stsf",	0x9E,		0,	1,	OP (rsym_rrii_rrri),	T (dref)},
