...
const struct dadao_opcode dadao_opcodes[] =
 {
	...
	{"cs.n",	0x40,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.z",	0x42,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.p",	0x44,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.od",	0x46,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.nn",	0x48,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.nz",	0x4A,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.np",	0x4C,		0,	1,	OP (rrii_rrri),		T (simm)},
	{"cs.ev",	0x4E,		0,	1,	OP (rrii_rrri),		T (simm)},
