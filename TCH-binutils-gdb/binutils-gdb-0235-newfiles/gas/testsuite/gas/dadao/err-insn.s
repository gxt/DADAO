...
_start:
 ...
 ldmo rb2, rb1, rd2, 63;	# { dg-error "the number of registers exceeds the limit" "" }
 stmo rb2, rb1, rd2, 63;	# { dg-error "the number of registers exceeds the limit" "" }
 ...
 ldmo ra2, rb2, rd2, 63;	# { dg-error "the number of registers exceeds the limit" "" }
 stmo ra2, rb2, rd2, 63;	# { dg-error "the number of registers exceeds the limit" "" }
